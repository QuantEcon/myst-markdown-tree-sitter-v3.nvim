...
((fenced_code_block
  ...
  (#match? @_lang "^{code-cell}\\s+python")
...
((fenced_code_block
  (info_string) @_lang
  (code_fence_content) @injection.content)
  (#match? @_lang "^{code-cell}\\s+javascript")
...
((fenced_code_block
  (info_string) @_lang
  (code_fence_content) @injection.content)
  (#match? @_lang "^{code-cell}\\s+typescript")
